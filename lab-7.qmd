...
leaflet(capitals_with_passes) |> addTiles() %>%
  addCircleMarkers(lng = capitals_with_passes$longitude, lat = capitals_with_passes$latitude,
             popup = paste(
      "<b>", capitals_with_passes$capital, "</b><br/>",
      "Next Three ISS Passtimes: ", as_datetime(capitals_with_passes$pass_time_1)))
